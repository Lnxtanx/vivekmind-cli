 ...
 */
import type { AgentEventEmitter } from '@vivekmind/core';
...
export declare class SubAgentTracker {
    ...
    constructor(ctx: SessionContext, client: AgentSideConnection, parentToolCallId: string, subagentType: string);
    /**
