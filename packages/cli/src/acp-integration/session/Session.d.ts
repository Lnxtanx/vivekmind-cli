...
import type { PromptRequest, PromptResponse, RequestPermissionRequest, RequestPermissionResponse, SessionUpdate, SetSessionModeRequest, SetSessionModeResponse, SetSessionModelRequest, SetSessionModelResponse, AgentSideConnection } from '@agentclientprotocol/sdk';
...
export declare class Session implements SessionContext {
     ...
     */
    setModel(params: SetSessionModelRequest): Promise<SetSessionModelResponse | void>;
    /**
