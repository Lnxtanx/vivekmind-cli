...
import { FatalConfigError, getErrorMessage, isWithinRoot, ideContextStore, } from '@vivekmind/core';
...
export function getTrustedFoldersPath() {
    if (process.env['VIVEKMIND_CODE_TRUSTED_FOLDERS_PATH']) {
        return process.env['VIVEKMIND_CODE_TRUSTED_FOLDERS_PATH'];
    }
