...
import { FatalConfigError, ideContextStore } from '@vivekmind/core';
...
describe('Trusted Folders Loading', () => {
    ...
    it('should use VIVEKMIND_CODE_TRUSTED_FOLDERS_PATH env var if set', () => {
        const customPath = '/custom/path/to/trusted_folders.json';
        process.env['VIVEKMIND_CODE_TRUSTED_FOLDERS_PATH'] = customPath;
        ...
        expect(errors).toEqual([]);
        delete process.env['VIVEKMIND_CODE_TRUSTED_FOLDERS_PATH'];
    });
