 ...
 */
import { ApprovalMode, DEFAULT_TRUNCATE_TOOL_OUTPUT_LINES, DEFAULT_TRUNCATE_TOOL_OUTPUT_THRESHOLD, } from '@vivekmind/core';
    ...
    general: {
        ...
        properties: {
            ...
            gitCoAuthor: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Automatically add a Co-authored-by trailer to git commit messages when commits are made through VivekMind.',
                showInDialog: true,
            },
            checkpointing: {
                type: 'object',
            ...
            outputLanguage: {
                ...
                requiresRestart: true,
                default: 'auto',
                description: 'The language for LLM output. Use "auto" to detect from system settings, ' +
    ...
    ui: {
        ...
        properties: {
            ...
            showStatusInTitle: {
                ...
                requiresRestart: false,
                default: false,
                description: 'Show VivekMind status and thoughts in the terminal window title',
                showInDialog: false,
            },
            hideTips: {
                type: 'boolean',
            ...
            enableUserFeedback: {
                ...
                requiresRestart: false,
                default: true,
                description: 'Show optional feedback dialog after conversations to help improve VivekMind performance.',
                showInDialog: true,
            },
            ...
            generationConfig: {
                ...
                properties: {
                    ...
                    contextWindowSize: {
                        ...
                        requiresRestart: false,
                        default: undefined,
                        description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from VivekMind's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
                        parentKey: 'generationConfig',
                        showInDialog: false,
                    },
                },
    ...
    tools: {
        ...
        properties: {
            ...
            sandboxImage: {
                ...
                requiresRestart: true,
                default: undefined,
                description: 'Sandbox image URI used by Docker/Podman when --sandbox-image and VIVEKMIND_SANDBOX_IMAGE are not set.',
                showInDialog: false,
            },
            shell: {
                type: 'object',
            ...
            arena: {
                ...
                properties: {
                    worktreeBaseDir: {
                        ...
                        requiresRestart: true,
                        default: undefined,
                        description: 'Custom base directory for Arena worktrees. Defaults to ~/.vivekmind/arena.',
                        showInDialog: false,
                    },
                    preserveArtifacts: {
                        type: 'boolean',
    ...
    experimental: {
        ...
        properties: {
            cron: {
                ...
                requiresRestart: true,
                default: false,
                description: 'Enable in-session cron/loop tools (experimental). When enabled, the model can create recurring prompts using cron_create, cron_list, and cron_delete tools. Can also be enabled via VIVEKMIND_CODE_ENABLE_CRON=1 environment variable.',
                showInDialog: true,
            },
