  ...
  general: {
    ...
    properties: {
      ...
      gitCoAuthor: {
        ...
        default: true,
        description:
          'Automatically add a Co-authored-by trailer to git commit messages when commits are made through VivekMind.',
        showInDialog: true,
      },
      checkpointing: {
        type: 'object',
  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show VivekMind status and thoughts in the terminal window title',
        showInDialog: false,
      },
      hideTips: {
        type: 'boolean',
      ...
      generationConfig: {
        ...
        properties: {
          ...
          contextWindowSize: {
            ...
            default: undefined,
            description:
              "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from VivekMind's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.",
            parentKey: 'generationConfig',
            showInDialog: false,
          },
        },
