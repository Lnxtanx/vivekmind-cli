 ...
 */
import type { MCPServerConfig, BugCommandSettings, TelemetrySettings, AuthType, ChatCompressionSettings, ModelProvidersConfig } from '@vivekmind/core';
    ...
    readonly general: {
        ...
        readonly properties: {
            ...
            readonly gitCoAuthor: {
                ...
                readonly requiresRestart: false;
                readonly default: true;
                readonly description: "Automatically add a Co-authored-by trailer to git commit messages when commits are made through VivekMind.";
                readonly showInDialog: true;
            };
    ...
    readonly ui: {
        ...
        readonly properties: {
            ...
            readonly statusLine: {
                ...
                readonly description: "Custom status line display configuration. Optional `refreshInterval` (seconds, >= 1) re-runs the command on a timer so external data stays fresh.";
                readonly showInDialog: false;
            };
            ...
            readonly showStatusInTitle: {
                ...
                readonly requiresRestart: false;
                readonly default: false;
                readonly description: "Show VivekMind status and thoughts in the terminal window title";
                readonly showInDialog: false;
            };
            readonly hideTips: {
                readonly type: "boolean";
            ...
            readonly enableUserFeedback: {
                ...
                readonly requiresRestart: false;
                readonly default: true;
                readonly description: "Show optional feedback dialog after conversations to help improve VivekMind performance.";
                readonly showInDialog: true;
            };
            ...
            readonly generationConfig: {
                ...
                readonly properties: {
                    ...
                    readonly contextWindowSize: {
                        ...
                        readonly description: "Overrides the default context window size for the selected model. Use this setting when a provider's effective context limit differs from VivekMind's default. This value defines the model's assumed maximum context capacity, not a per-request token limit.";
                        readonly parentKey: "generationConfig";
                        readonly showInDialog: false;
                    };
                };
        ...
        readonly properties: {
            ...
            readonly fileFiltering: {
                ...
                readonly properties: {
                    ...
                    readonly respectVivekMindIgnore: {
                        readonly type: "boolean";
                        readonly label: "Respect .vivekmindignore";
                        readonly category: "Context";
                        readonly requiresRestart: true;
                        readonly default: true;
                        readonly description: "Respect .vivekmindignore files when searching";
                        readonly showInDialog: true;
                    };
    ...
    readonly tools: {
        ...
        readonly properties: {
            ...
            readonly sandboxImage: {
                ...
                readonly requiresRestart: true;
                readonly default: string | undefined;
                readonly description: "Sandbox image URI used by Docker/Podman when --sandbox-image and VIVEKMIND_SANDBOX_IMAGE are not set.";
                readonly showInDialog: false;
            };
            readonly shell: {
                readonly type: "object";
            ...
            readonly arena: {
                ...
                readonly properties: {
                    readonly worktreeBaseDir: {
                        ...
                        readonly requiresRestart: true;
                        readonly default: string | undefined;
                        readonly description: "Custom base directory for Arena worktrees. Defaults to ~/.vivekmind/arena.";
                        readonly showInDialog: false;
                    };
    ...
    readonly experimental: {
        ...
        readonly properties: {
            readonly cron: {
                ...
                readonly requiresRestart: true;
                readonly default: false;
                readonly description: "Enable in-session cron/loop tools (experimental). When enabled, the model can create recurring prompts using cron_create, cron_list, and cron_delete tools. Can also be enabled via VIVEKMIND_CODE_ENABLE_CRON=1 environment variable.";
                readonly showInDialog: true;
            };
