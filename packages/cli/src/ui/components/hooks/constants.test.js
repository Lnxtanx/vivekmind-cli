...
import { HookEventName, HooksConfigSource } from '@vivekmind/core';
// Mock i18n module
vi.mock('../../../i18n/index.js', () => ({
    t: vi.fn((key) => key),
}));
// Import after mocking
import { getHookExitCodes, getHookShortDescription, getHookDescription, getTranslatedSourceDisplayMap, createEmptyHookEventInfo, DISPLAY_HOOK_EVENTS, } from './constants.js';
describe('hooks constants', () => {
    ...
    describe('createEmptyHookEventInfo', () => {
        ...
        it('should create empty info for Stop', () => {
            ...
            expect(info.shortDescription).toBe('Right before VivekMind concludes its response');
