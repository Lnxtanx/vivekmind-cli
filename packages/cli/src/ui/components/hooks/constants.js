 ...
 */
import { HooksConfigSource, HookEventName } from '@vivekmind/core';
...
export function getHookExitCodes(eventName) {
    const exitCodesMap = {
        ...
        [HookEventName.UserPromptSubmit]: [
            { code: 0, description: t('stdout shown to VivekMind') },
            {
                code: 2,
...
export function getHookShortDescription(eventName) {
    const descriptions = {
        ...
        [HookEventName.Stop]: t('Right before VivekMind concludes its response'),
...
export function getHookDescription(eventName) {
    const descriptions = {
        ...
        [HookEventName.UserPromptSubmit]: t('Input to command is JSON with original user prompt text.'),
