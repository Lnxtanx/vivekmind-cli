        ...
        it('shows main and subagent suffixes when the same model has multiple sources', () => {
            ...
            const metrics = {
                models: {
                    'glm-5': {
                        api: {
                            totalRequests: mainCore.api.totalRequests + echoerCore.api.totalRequests,
                            totalErrors: 0,
                            totalLatencyMs: 200,
                        },
                        tokens: {
                            prompt: mainCore.tokens.prompt + echoerCore.tokens.prompt,
                            candidates: mainCore.tokens.candidates + echoerCore.tokens.candidates,
