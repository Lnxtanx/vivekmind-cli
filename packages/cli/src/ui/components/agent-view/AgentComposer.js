...
import { AgentStatus, isTerminalStatus, ApprovalMode, APPROVAL_MODES, } from '@vivekmind/core';
...
export const AgentComposer = ({ agentId }) => {
    ...
    const prefixNode = (_jsxs(Text, { color: statusColor ?? theme.text.accent, children: [isYolo ? '*' : '>', " "] }));
