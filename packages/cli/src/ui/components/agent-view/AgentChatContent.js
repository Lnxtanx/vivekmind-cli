...
import { AgentStatus, AgentEventType, getGitBranch, } from '@vivekmind/core';
...
export const AgentChatContent = ({ core, interactiveAgent, instanceKey, modelName, }) => {
    ...
    return (_jsxs(Box, { flexDirection: "column", children: [_jsx(Static, { items: [
                    ...
                    ...committedItems.map((item) => (_jsx(HistoryItemDisplay, { item: item, isPending: false, terminalWidth: terminalWidth, mainAreaWidth: contentWidth }, item.id))),
