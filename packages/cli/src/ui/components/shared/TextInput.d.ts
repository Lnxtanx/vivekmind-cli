...
export declare function TextInput({ value, onChange, onSubmit, onTab, onUp, onDown, placeholder, height, isActive, validationErrors, inputWidth, initialCursorOffset, }: TextInputProps): import("react/jsx-runtime").JSX.Element | null;
