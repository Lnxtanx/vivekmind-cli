...
export function MultiSelect({ items, initialIndex = 0, selectedKeys = EMPTY_SELECTED_KEYS, onConfirm, onChange, onSelectedKeysChange, onHighlight, isFocused = true, showNumbers = true, showScrollArrows = false, maxItemsToShow = 10, }) {
