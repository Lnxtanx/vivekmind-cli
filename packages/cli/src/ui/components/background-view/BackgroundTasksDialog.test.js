...
function setup(initial) {
    ...
    function Harness() {
        ...
        return (_jsx(ConfigContext.Provider, { value: config, children: _jsxs(BackgroundTaskViewProvider, { config: config, children: [_jsx(Probe, { entriesSetter: setEntries }), _jsx(BackgroundTasksDialog, { availableTerminalHeight: 30, terminalWidth: 80 })] }) }));
    }
    ...
    const { lastFrame } = render(_jsx(Harness, {}));
    return {
        cancel,
        resume,
        abandon,
