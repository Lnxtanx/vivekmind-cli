...
const renderComponent = (props = {}, contextValue = undefined) => {
    ...
    const renderResult = render(_jsx(SettingsContext.Provider, { value: mockSettings, children: _jsx(ConfigContext.Provider, { value: mockConfig, children: _jsx(ModelDialog, { ...combinedProps }) }) }));
    return {
        ...renderResult,
        props: combinedProps,
        mockConfig,
...
describe('<ModelDialog />', () => {
    ...
    it('passes all model options to DescriptiveRadioButtonSelect', () => {
        ...
        expect(props.items[0].value).toBe(`${AuthType.VIVEKMIND_OAUTH}::${DEFAULT_VIVEKMIND_MODEL}`);
    ...
    it('initializes with the model from ConfigContext', () => {
        ...
        const expectedIndex = qwenModels.findIndex((m) => m.id === DEFAULT_VIVEKMIND_MODEL);
    ...
    it('blocks switching to vivekmind-oauth from another authType (discontinued)', async () => {
        ...
        const { props } = renderComponent({}, mockConfigWithSwitchAuthType);
        const childOnSelect = mockedSelect.mock.calls[0][0].onSelect;
        await childOnSelect(`${AuthType.VIVEKMIND_OAUTH}::${DEFAULT_VIVEKMIND_MODEL}`);
        // vivekmind-oauth is discontinued — switchModel should NOT be called
    ...
    it('updates initialIndex when config context changes', () => {
        ...
        const qwenModels = getFilteredQwenModels();
        const expectedCoderIndex = qwenModels.findIndex((m) => m.id === DEFAULT_VIVEKMIND_MODEL);
