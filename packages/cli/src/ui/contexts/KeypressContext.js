...
import { KittySequenceOverflowEvent, logKittySequenceOverflow, createDebugLogger, } from '@vivekmind/core';
...
export function KeypressProvider({ children, kittyProtocolEnabled, pasteWorkaround = false, config, debugKeystrokeLogging, initialCapturedInput, }) {
    ...
    return (_jsx(KeypressContext.Provider, { value: { subscribe, unsubscribe, pasteWorkaround }, children: children }));
}
