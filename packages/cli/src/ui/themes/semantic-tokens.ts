...
export const lightSemanticColors: SemanticColors = {
  text: {
    ...
    accent: lightTheme.AccentRed,
    assistant: lightTheme.AccentBlue,
...
export const darkSemanticColors: SemanticColors = {
  text: {
    ...
    accent: darkTheme.AccentRed,
    assistant: darkTheme.AccentBlue,
...
export const ansiSemanticColors: SemanticColors = {
  text: {
    ...
    accent: ansiTheme.AccentRed,
    assistant: ansiTheme.AccentBlue,
