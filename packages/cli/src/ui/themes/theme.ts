  ...
  constructor(
    ...
    this.semanticColors = semanticColors ?? {
      text: {
        ...
        accent: this.colors.AccentRed,
        assistant: this.colors.AccentBlue,
...
export function createCustomTheme(customTheme: CustomTheme): Theme {
  ...
  const semanticColors: SemanticColors = {
    text: {
      ...
      accent: customTheme.text?.accent ?? colors.AccentRed,
      assistant: customTheme.text?.link ?? colors.AccentBlue,
