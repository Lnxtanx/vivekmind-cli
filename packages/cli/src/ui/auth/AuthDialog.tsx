...
export function AuthDialog(): React.JSX.Element {
  ...
  const PROVIDER_DEFAULT_MODELS: Record<string, string> = {
    ...
    [AuthType.USE_BEDROCK]: 'anthropic.claude-opus-4-7,anthropic.claude-sonnet-4-6,anthropic.claude-haiku-4-5-20251001-v1:0,vivekmind.vivekmind3-coder-next,vivekmind.vivekmind3-coder-30b-a3b-v1:0,deepseek.v3.2,deepseek.r1-v1:0,zai.glm-5,zai.glm-4.7,mistral.devstral-2-123b,mistral.mistral-large-3-675b-instruct,amazon.nova-pro-v1:0,amazon.nova-2-sonic-v1:0,meta.llama4-maverick-17b-instruct-v1:0,meta.llama4-scout-17b-instruct-v1:0,nvidia.nemotron-super-3-120b,moonshotai.kimi-k2.5',
    [AuthType.USE_OLLAMA]: 'llama3.3:70b,vivekmind2.5-coder:32b,deepseek-r1:70b',
    ...
    [AuthType.USE_TOGETHER]: 'meta-llama/Llama-3.3-70B-Instruct-Turbo,deepseek-ai/DeepSeek-V3,VivekMind/VivekMind3-235B-A22B',
    ...
    [AuthType.USE_DASHSCOPE]: 'vivekmind3-coder-plus,vivekmind-max,vivekmind-vl-max',
    ...
    [AuthType.USE_SILICONFLOW]: 'deepseek-ai/DeepSeek-V3,VivekMind/VivekMind3-235B-A22B,meta-llama/Meta-Llama-3.1-405B-Instruct',
