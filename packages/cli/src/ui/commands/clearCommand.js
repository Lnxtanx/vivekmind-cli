...
import { uiTelemetryService, SessionEndReason, SessionStartSource, ToolNames, } from '@vivekmind/core';
...
export const clearCommand = {
    ...
    action: async (context, _args) => {
        ...
        if (config) {
            ...
            config
                .getHookSystem()
                ?.fireSessionStartEvent(SessionStartSource.Clear, config.getModel() ?? '', String(config.getApprovalMode()))
                .catch((err) => {
