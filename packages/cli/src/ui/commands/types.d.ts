...
import type { Config, GitService, Logger, SessionListItem } from '@vivekmind/core';
...
export interface OpenDialogActionReturn {
    ...
    dialog: 'help' | 'arena_start' | 'arena_select' | 'arena_stop' | 'arena_status' | 'auth' | 'theme' | 'editor' | 'settings' | 'memory' | 'model' | 'fast-model' | 'manage-models' | 'subagent_create' | 'subagent_list' | 'trust' | 'permissions' | 'approval-mode' | 'resume' | 'delete' | 'extensions_manage' | 'hooks' | 'mcp' | 'rewind';
}
/**
 ...
 */
export type CommandSource = 'builtin-command' | 'bundled-skill' | 'skill-dir-command' | 'plugin-command' | 'mcp-prompt';
