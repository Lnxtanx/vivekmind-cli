 ...
 */
import { IdeClient, logIdeConnection, IdeConnectionEvent, IdeConnectionType, } from '@vivekmind/core';
import { VIVEKMIND_CODE_COMPANION_EXTENSION_NAME, getIdeInstaller, IDEConnectionStatus, ideContextStore, } from '@vivekmind/core';
    ...
    if (!currentIDE) {
        return {
            ...
            action: () => ({
                type: 'message',
                messageType: 'error',
                content: t('IDE integration is not supported in your current environment. To use this feature, run VivekMind in one of these supported IDEs: VS Code or VS Code forks.'),
            }),
        };
    }
