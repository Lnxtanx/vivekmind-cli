...
describe('manageModelsCommand', () => {
    ...
    it('should have the correct name and description', () => {
        ...
        expect(manageModelsCommand.description).toBe('Browse dynamic model catalogs and choose which models stay enabled locally');
    });
});
//# sourceMappingURL=manageModelsCommand.test.js.map