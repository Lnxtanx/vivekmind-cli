...
export const setupGithubCommand = {
    ...
    action: async (context) => {
        ...
        const readmeUrl = `https://github.com/VivekMind/vivekmind-action/blob/${releaseTag}/README.md#quick-start`;
        ...
        return {
            ...
            toolArgs: {
                description: 'Setting up GitHub Actions to triage issues and review PRs with VivekMind.',
                command,
                is_background: false,
            },
        };
