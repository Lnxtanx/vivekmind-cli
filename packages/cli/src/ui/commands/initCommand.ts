...
import { getCurrentGeminiMdFilename } from '@vivekmind/core';
...
export const initCommand: SlashCommand = {
  name: 'init',
  get description() {
    return t('Analyzes the project and creates a tailored VIVEKMIND.md file.');
  },
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are VivekMind, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
