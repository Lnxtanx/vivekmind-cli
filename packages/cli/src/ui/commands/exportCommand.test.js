...
import { collectSessionData, normalizeSessionData, toMarkdown, toHtml, generateExportFilename, } from '../utils/export/index.js';
...
describe('exportCommand', () => {
    ...
    describe('exportMarkdownAction', () => {
        it('should export session to markdown file', async () => {
            ...
            expect(fs.writeFile).toHaveBeenCalledWith(expect.stringContaining('export-2025-01-01T00-00-00-000Z.md'), '# Test Markdown', 'utf-8');
        });
    ...
    describe('exportHtmlAction', () => {
        it('should export session to HTML file', async () => {
            ...
            expect(fs.writeFile).toHaveBeenCalledWith(expect.stringContaining('export-2025-01-01T00-00-00-000Z.html'), expect.stringContaining('{"data": "test"}'), 'utf-8');
        });
        it('should return error when config is not available', async () => {
            const contextWithoutConfig = createMockCommandContext({
                services: {
