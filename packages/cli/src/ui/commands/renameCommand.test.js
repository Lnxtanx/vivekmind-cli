...
describe('renameCommand', () => {
    ...
    describe('bare /rename model selection', () => {
        ...
        function mockConfigForKebab(opts) {
    ...
    describe('--auto flag', () => {
        it('refuses --auto when no fast model is configured', async () => {
            ...
            expect(result).toEqual({
                type: 'message',
                messageType: 'error',
                content: '/rename --auto requires a fast model. Configure one with `/model --fast <model>`.',
            });
        ...
        it('surfaces model_error reason distinctly', async () => {
            ...
            expect(result.content).toMatch(/rate limit, auth, or network error/);
        });
