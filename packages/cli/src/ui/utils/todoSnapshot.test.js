...
import { STICKY_TODO_MAX_VISIBLE_ITEMS, getStickyTodoMaxVisibleItems, getStickyTodos, getStickyTodosLayoutKey, getStickyTodosRenderKey, } from './todoSnapshot.js';
...
describe('sticky todo layout helpers', () => {
    it('keeps the layout key stable for status-only updates', () => {
        ...
        expect(getStickyTodosLayoutKey(pendingTodos, 64, 5)).toBe(getStickyTodosLayoutKey(inProgressTodos, 64, 5));
