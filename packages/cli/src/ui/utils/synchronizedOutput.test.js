...
import { BEGIN_SYNCHRONIZED_UPDATE, END_SYNCHRONIZED_UPDATE, getSynchronizedOutputStatsSnapshot, installSynchronizedOutput, resetSynchronizedOutputStats, terminalSupportsSynchronizedOutput, } from './synchronizedOutput.js';
...
describe('terminalSupportsSynchronizedOutput', () => {
    it.each([
        ...
        [{ TERM_PROGRAM: 'WezTerm', VIVEKMIND_CODE_SYNCHRONIZED_OUTPUT: '0' }, false],
        [
            {
                TERM_PROGRAM: 'WezTerm',
                VIVEKMIND_CODE_DISABLE_SYNCHRONIZED_OUTPUT: '1',
                VIVEKMIND_CODE_FORCE_SYNCHRONIZED_OUTPUT: '1',
            },
            false,
        ],
        [
...
describe('installSynchronizedOutput', () => {
    ...
    it('preserves write return values and callbacks', async () => {
        ...
        const write = vi.fn((_chunk, encodingOrCallback) => {
...
//# sourceMappingURL=synchronizedOutput.test.js.map