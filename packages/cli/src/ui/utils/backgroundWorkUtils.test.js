...
import { hasBlockingBackgroundWork, resetBackgroundStateForSessionSwitch, } from './backgroundWorkUtils.js';
...
describe('hasBlockingBackgroundWork', () => {
    ...
    it('returns true when background tasks are unfinalized', () => {
        expect(hasBlockingBackgroundWork(createMockConfig({ hasUnfinalizedTasks: true }))).toBe(true);
    });
