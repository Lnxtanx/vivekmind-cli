...
function createRankedCommandMatch(command, matchedValue, query, result, originalIndex) {
    return {
        command,
                        ...
                        try {
                            ...
                            fzfResults.forEach((result) => {
                                ...
                                if (cmd && cmd.description && originalIndex !== undefined) {
                                    const rankedMatch = createRankedCommandMatch(cmd, result.item, partial, result, originalIndex);
