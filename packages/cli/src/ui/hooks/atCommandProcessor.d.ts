 ...
 */
export declare function handleAtCommand({ query, config, onDebugMessage, messageId: userMessageTimestamp, signal, addItem, }: HandleAtCommandParams): Promise<HandleAtCommandResult>;
export {};
