...
describe('AppContainer State Management', () => {
    ...
    describe('Context Providers', () => {
        ...
        it('passes a remount-only refresh callback to slash commands', () => {
            ...
            mockedUseSlashCommandProcessor.mockImplementation((_config, _settings, _addItem, _clearItems, _loadHistory, refreshStatic) => {
    ...
    describe('Terminal Height Calculation', () => {
        ...
        it('does not remeasure footer height for sticky todo status-only updates', () => {
            ...
            expect(mockedMeasureElement).toHaveBeenCalledTimes(callsAfterInitialRender);
        });
    });
