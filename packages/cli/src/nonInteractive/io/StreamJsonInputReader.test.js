...
import { StreamJsonInputReader, StreamJsonParseError, } from './StreamJsonInputReader.js';
    ...
    describe('read', () => {
        ...
        it.each([
            ...
            },
            {
                ...
                input: JSON.stringify({ session_id: 'test-session', message: 'hello' }) +
                    '\n',
        ...
        ])('should throw StreamJsonParseError for $name', async ({ input: inputLine, expectedError }) => {
            const input = new PassThrough();
            const reader = new StreamJsonInputReader(input);
        ...
        it('should use process.stdin as default input', () => {
            ...
            expect(reader.input).toBe(process.stdin);
        });
        it('should use provided input stream', () => {
            ...
            expect(reader.input).toBe(customInput);
        });
    });
});
//# sourceMappingURL=StreamJsonInputReader.test.js.map