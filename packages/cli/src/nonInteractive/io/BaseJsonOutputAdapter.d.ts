 ...
 */
import type { Config, ToolCallRequestInfo, ToolCallResponseInfo, SessionMetrics, ServerGeminiStreamEvent, AgentResultDisplay, McpToolProgressData } from '@vivekmind/core';
import type { Part, GenerateContentResponseUsageMetadata } from '@google/genai';
import type { CLIAssistantMessage, CLIMessage, CLIPermissionDenial, CLIResultMessage, CLIResultMessageError, ContentBlock, ControlMessage, ExtendedUsage, TextBlock, ThinkingBlock, ToolUseBlock, Usage } from '../types.js';
/**
...
export declare abstract class BaseJsonOutputAdapter {
     ...
     */
    emitPermissionRequest(requestId: string, toolName: string, toolUseId: string, input: unknown, blockedPath?: string | null): void;
    /**
