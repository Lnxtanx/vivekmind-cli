import type { SubagentConfig, McpToolProgressData } from '@vivekmind/core';
/**
...
export type StreamEvent = MessageStartStreamEvent | ContentBlockStartEvent | ContentBlockDeltaEvent | ContentBlockStopEvent | MessageStopStreamEvent | ToolProgressStreamEvent;
