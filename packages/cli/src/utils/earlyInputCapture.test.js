...
import { startEarlyInputCapture, stopEarlyInputCapture, getAndClearCapturedInput, stopAndGetCapturedInput, hasCapturedInput, resetCaptureState, } from './earlyInputCapture.js';
...
describe('earlyInputCapture', () => {
    ...
    beforeEach(() => {
        ...
        delete process.env['VIVEKMIND_CODE_DISABLE_EARLY_CAPTURE'];
    });
    afterEach(() => {
        resetCaptureState();
    ...
    describe('edge cases', () => {
        ...
        it('should skip when VIVEKMIND_CODE_DISABLE_EARLY_CAPTURE is set', () => {
            process.env['VIVEKMIND_CODE_DISABLE_EARLY_CAPTURE'] = '1';
            startEarlyInputCapture();
            mockStdin.write(Buffer.from('a'));
            stopEarlyInputCapture();
            expect(hasCapturedInput()).toBe(false);
...
//# sourceMappingURL=earlyInputCapture.test.js.map