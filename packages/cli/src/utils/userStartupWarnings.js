...
import { canUseRipgrep } from '@vivekmind/core';
    ...
    check: async (options) => {
        try {
            ...
            if (workspaceRealPath === homeRealPath) {
                return 'You are running VivekMind in your home directory. It is recommended to run in a project-specific directory.';
            }
            return null;
        }
        catch (_err) {
...
const rootDirectoryCheck = {
    ...
    check: async (options) => {
        try {
            ...
            const errorMessage = 'Warning: You are running VivekMind in the root directory. Your entire folder structure will be used for context. It is strongly recommended to run in a project-specific directory.';
