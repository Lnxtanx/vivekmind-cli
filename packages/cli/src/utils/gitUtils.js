...
export const getLatestGitHubRelease = async (proxy) => {
    try {
        ...
        const endpoint = `https://api.github.com/repos/VivekMind/vivekmind-action/releases/latest`;
        ...
        debugLogger.debug(`Failed to determine latest vivekmind-action release:`, _error);
        throw new Error(`Unable to determine the latest vivekmind-action release on GitHub.`);
    }
};
/**
