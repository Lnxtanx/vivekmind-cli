...
import { OUTPUT_LANGUAGE_AUTO, isAutoLanguage, normalizeOutputLanguage, resolveOutputLanguage, writeOutputLanguageFile, updateOutputLanguageFile, initializeLlmOutputLanguage, } from './languageUtils.js';
describe('languageUtils', () => {
    ...
    describe('writeOutputLanguageFile', () => {
        ...
        it('should create directory and write file', () => {
            ...
            const globalDir = '/mock/home/.vivekmind';
        ...
        it('should include machine-readable marker', () => {
            writeOutputLanguageFile('Chinese');
            const writtenContent = vi.mocked(fs.writeFileSync).mock.calls[0][1];
            expect(writtenContent).toContain('<!-- vivekmind:llm-output-language: Chinese -->');
        });
        it('should sanitize language for marker (remove dangerous characters)', () => {
            ...
            expect(writtenContent).toContain('<!-- vivekmind:llm-output-language: TestLanguage -->');
        });
...
<!-- vivekmind:llm-output-language: French -->
`);
            initializeLlmOutputLanguage();
...
`);
    ...
    describe('output-language.md path resolution priority', () => {
        it('should prefer project-level path over global path', () => {
            const projectPath = '/project/.vivekmind/output-language.md';
            const globalPath = '/mock/home/.vivekmind/output-language.md';
