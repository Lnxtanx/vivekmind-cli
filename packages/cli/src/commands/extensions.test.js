...
describe('extensions command', () => {
    ...
    it('should have a description', () => {
        expect(extensionsCommand.describe).toBe('Manage VivekMind extensions.');
    });
    ...
    it('should register install subcommand', () => {
        ...
        expect(() => parser.parse('extensions install')).toThrow('Not enough non-option arguments');
    });
    it('should register uninstall subcommand', () => {
        const parser = yargs([])
            ...
            .fail(false)
            .locale('en');
        expect(() => parser.parse('extensions uninstall')).toThrow('Not enough non-option arguments');
    });
