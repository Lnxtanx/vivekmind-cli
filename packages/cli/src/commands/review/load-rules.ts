...
// `vivekmind review load-rules`: read project-specific code-review rules from
...
// PR cannot inject `.vivekmind/review-rules.md` content that bypasses scrutiny.
// Sources, in order:
//
//   1. `.vivekmind/review-rules.md`
