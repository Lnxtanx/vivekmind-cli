 ...
 */
import type { Config, ServerGeminiStreamEvent, ToolCallRequestInfo, ToolCallResponseInfo } from '@vivekmind/core';
 ...
 */
export declare const DUAL_OUTPUT_PROTOCOL_VERSION = 1;
/**
