 ...
 */
export function computeCodingPlanVersion(template) {
 ...
 */
export function generateCodingPlanTemplate(region) {
 ...
 */
export function getCodingPlanConfig(region) {
    const template = generateCodingPlanTemplate(region);
    const baseUrl = region === CodingPlanRegion.CHINA
 ...
 */
export function getCodingPlanBaseUrls() {
    return [
        'https://coding.dashscope.aliyuncs.com/v1',
        'https://coding-intl.dashscope.aliyuncs.com/v1',
    ];
 ...
 */
export function getRegionFromBaseUrl(baseUrl) {
    if (!baseUrl)
        return null;
    if (baseUrl === 'https://coding.dashscope.aliyuncs.com/v1') {
        return CodingPlanRegion.CHINA;
