...
import { type SlashCommand, type ExecutionMode } from './ui/commands/types.js';
 ...
 */
export declare const handleSlashCommand: (rawQuery: string, abortController: AbortController, config: Config, settings: LoadedSettings) => Promise<NonInteractiveSlashCommandResult>;
/**
 ...
 */
export declare const getAvailableCommands: (config: Config, abortSignal: AbortSignal, mode?: ExecutionMode) => Promise<SlashCommand[]>;
