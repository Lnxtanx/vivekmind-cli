 ...
 */
import { flatMapTextParts, readPathFromWorkspace, createDebugLogger, } from '@vivekmind/core';
            ...
            for (const injection of injections) {
                ...
                try {
                    ...
                    if (fileContentParts.length === 0) {
                        const uiMessage = `File '@{${pathStr}}' was ignored by .gitignore or .vivekmindignore and was not included in the prompt.`;
