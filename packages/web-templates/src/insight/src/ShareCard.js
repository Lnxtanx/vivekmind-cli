    ...
    return (_jsxs("div", { id: "share-card", style: {
            ...
            boxSizing: 'border-box',
                    ...
                    marginBottom: '32px',
                                    ...
                                    lineHeight: 1.2,
                                }, children: "VivekMind Insights" }), _jsx("div", { style: {
                                    fontSize: '14px',
                                    color: t.textMuted,
                                    marginTop: '6px',
                            ...
                            paddingTop: '8px',
                        }, children: "vivekmind.com" })] }), _jsxs("div", { style: {
                    display: 'grid',
                    ...
                    flexShrink: 0,
                }, children: [_jsxs("div", { style: { fontSize: '12px', color: t.textMuted }, children: ["Generated by VivekMind \u00B7 ", new Date().toISOString().split('T')[0]] }), _jsx("div", { style: { fontSize: '12px', color: t.textMuted }, children: "github.com/Lnxtanx/vivekmind-cli" })] })] }));
}
