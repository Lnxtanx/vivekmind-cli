...
export function InteractionStyle({ qualitative, insights, }) {
    ...
    if (!interactionStyle)
        return null;
    return (_jsxs(_Fragment, { children: [_jsx("h2", { id: "section-usage", className: "text-xl font-semibold text-slate-900 mt-8 mb-4", children: "How You Use VivekMind" }), _jsxs("div", { className: "narrative", children: [_jsx("p", { children: _jsx(MarkdownText, { children: interactionStyle.narrative }) }), interactionStyle.key_pattern && (_jsxs("div", { className: "key-insight", children: [_jsx("strong", { children: "Key pattern:" }), ' ', _jsx(MarkdownText, { children: interactionStyle.key_pattern })] }))] }), _jsx(DashboardCards, { insights: insights }), _jsx(HeatmapSection, { heatmap: insights.heatmap })] }));
}
export function ImpressiveWorkflows({ qualitative, primarySuccess, outcomes, }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsx("h2", { id: "section-wins", className: "text-xl font-semibold text-slate-900 mt-8 mb-4", children: "Impressive Things You Did" }), impressiveWorkflows.intro && (_jsx("p", { className: "section-intro", children: _jsx(MarkdownText, { children: impressiveWorkflows.intro }) })), _jsx("div", { className: "big-wins", children: Array.isArray(impressiveWorkflows.impressive_workflows) &&
                    ...
                    marginTop: '24px',
                    marginBottom: '24px',
                }, children: [primarySuccess && Object.keys(primarySuccess).length > 0 && (_jsx(HorizontalBarChart, { data: primarySuccess, title: "What Helped Most (VivekMind's Capabilities)", color: "#3b82f6", allowedKeys: [
...
function VivekMindMdAdditionsSection({ additions, }) {
    ...
    return (_jsxs("div", { className: "vivekmind-md-section", children: [_jsx("h3", { children: "Suggested VIVEKMIND.md Additions" }), _jsx("p", { className: "text-xs text-slate-500 mb-3", children: "Just copy this into VivekMind to add it to your VIVEKMIND.md." }), _jsx("div", { className: "vivekmind-md-actions", style: { marginBottom: '12px' }, children: _jsx("button", { className: `copy-all-btn ${copiedAll ? 'copied' : ''}`, onClick: handleCopyAll, disabled: checkedCount === 0, children: copiedAll ? 'Copied All!' : `Copy All Checked (${checkedCount})` }) }), additions.map((item, idx) => (_jsxs("div", { className: "vivekmind-md-item", children: [_jsx("input", { type: "checkbox", checked: checkedState[idx], onChange: () => handleCheckboxChange(idx), className: "cmd-checkbox" }), _jsxs("div", { style: { flex: 1 }, children: [_jsx("code", { className: "cmd-code", children: item.addition }), _jsx("div", { className: "cmd-why", children: _jsx(MarkdownText, { children: item.why }) })] }), _jsx(CopyButton, { text: item.addition })] }, idx)))] }));
}
export function Improvements({ qualitative, }) {
    const { improvements } = qualitative;
    if (!improvements)
        return null;
    return (_jsxs(_Fragment, { children: [_jsx("h2", { id: "section-features", className: "text-xl font-semibold text-slate-900 mt-8 mb-4", children: "Existing VivekMind Features to Try" }), Array.isArray(improvements.VivekMind_md_additions) &&
                improvements.VivekMind_md_additions.length > 0 && (_jsx(VivekMindMdAdditionsSection, { additions: improvements.VivekMind_md_additions })), _jsx("p", { className: "text-xs text-slate-500 mb-3", children: "Just copy this into VivekMind and it'll set it up for you." }), _jsx("div", { className: "features-section", children: Array.isArray(improvements.features_to_try) &&
                    improvements.features_to_try.map((feat, idx) => (_jsxs("div", { className: "feature-card", children: [_jsx("div", { className: "feature-title", children: feat.feature }), _jsx("div", { className: "feature-oneliner", children: _jsx(MarkdownText, { children: feat.one_liner }) }), _jsxs("div", { className: "feature-why", children: [_jsx("strong", { children: "Why for you:" }), ' ', _jsx(MarkdownText, { children: feat.why_for_you })] }), _jsx("div", { className: "feature-examples", children: _jsx("div", { className: "feature-example", children: _jsxs("div", { className: "example-code-row", children: [_jsx("code", { className: "example-code", children: feat.example_code }), _jsx(CopyButton, { text: feat.example_code })] }) }) })] }, idx))) }), _jsx("h2", { id: "section-patterns", className: "text-xl font-semibold text-slate-900 mt-8 mb-4", children: "New Ways to Use VivekMind" }), _jsx("p", { className: "text-xs text-slate-500 mb-3", children: "Just copy this into VivekMind and it'll walk you through it." }), _jsx("div", { className: "patterns-section", children: Array.isArray(improvements.usage_patterns) &&
                    improvements.usage_patterns.map((pat, idx) => (_jsxs("div", { className: "pattern-card", children: [_jsx("div", { className: "pattern-title", children: pat.title }), _jsx("div", { className: "pattern-summary", children: _jsx(MarkdownText, { children: pat.suggestion }) }), _jsx("div", { className: "pattern-detail", children: _jsx(MarkdownText, { children: pat.detail }) }), _jsxs("div", { className: "copyable-prompt-section", children: [_jsx("div", { className: "prompt-label", children: "Paste into VivekMind:" }), _jsxs("div", { className: "copyable-prompt-row", children: [_jsx("code", { className: "copyable-prompt", children: pat.copyable_prompt }), _jsx(CopyButton, { text: pat.copyable_prompt })] })] })] }, idx))) })] }));
}
