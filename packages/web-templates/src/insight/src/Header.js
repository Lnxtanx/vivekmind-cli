...
export function Header({ data, dateRangeStr, }) {
    ...
    return (_jsxs("header", { className: "mb-8 space-y-3 text-center", children: [_jsx("h1", { className: "text-3xl font-semibold text-slate-900 md:text-4xl", children: "VivekMind Insights" }), _jsxs("p", { className: "text-sm text-slate-600", children: [totalMessages
