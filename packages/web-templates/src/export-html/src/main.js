...
const logoSvgWithGradient = (() => {
    ...
    const gradientDef = '<defs><linearGradient id="vivekmind-logo-gradient" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stop-color="#60a5fa" /><stop offset="100%" stop-color="#a855f7" /></linearGradient></defs>';
    const withDefs = logoSvg.replace(/<svg([^>]*)>/, `<svg$1>${gradientDef}`);
    return withDefs.replace(/fill="[^"]*"/, 'fill="url(#vivekmind-logo-gradient)"');
})();
const App = () => {
    ...
    return (_jsxs("div", { className: "page-wrapper", children: [_jsx("header", { className: "header", children: _jsxs("div", { className: "header-left", children: [_jsx("div", { className: "logo-icon", "aria-hidden": "true", dangerouslySetInnerHTML: { __html: logoSvgWithGradient } }), _jsx("div", { className: "logo", children: _jsx("div", { className: "logo-text", "data-text": "QWEN", children: _jsx("span", { className: "logo-text-inner", children: "QWEN" }) }) })] }) }), _jsxs("div", { className: "content-wrapper", children: [_jsx("div", { className: "chat-container", children: _jsx(PlatformProvider, { value: platformContext, children: _jsx(ChatViewer, { messages: messages, autoScroll: false, theme: "dark" }) }) }), metadata && _jsx(MetadataSidebar, { metadata: metadata })] }), _jsx(TempFileModal, { state: modalState, onClose: closeModal })] }));
};
