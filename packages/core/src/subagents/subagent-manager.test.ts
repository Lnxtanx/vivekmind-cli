  ...
  describe('loadSubagent', () => {
    it('should load subagent from project level first', async () => {
      ...
      expect(fs.readdir).toHaveBeenCalledWith(
        path.normalize('/test/project/.vivekmind/agents'),
      );
      expect(fs.readFile).toHaveBeenCalledWith(
        path.normalize('/test/project/.vivekmind/agents/test-agent.md'),
        'utf8',
      );
    });
    ...
    it('should fall back to user level if project level fails', async () => {
      ...
      expect(config!.name).toBe('test-agent');
      expect(fs.readdir).toHaveBeenCalledWith(
        path.normalize('/home/user/.vivekmind/agents'),
      );
      expect(fs.readFile).toHaveBeenCalledWith(
        path.normalize('/home/user/.vivekmind/agents/test-agent.md'),
        'utf8',
      );
    });
...
You are another assistant.`;
      ...
      expect(config!.filePath).toBe(
        path.normalize('/test/project/.vivekmind/agents/wrong-filename.md'),
      );
...
You are a helpful assistant.`;
      ...
      expect(config!.filePath).toBe(
        path.normalize('/home/user/.vivekmind/agents/user-agent.md'),
      );
...
You are a helpful assistant.`;
      ...
      expect(config!.filePath).toBe(
        path.normalize('/test/project/.vivekmind/agents/misnamed-file.md'),
      );
    });
  });
...
You are a helpful assistant.`;
      ...
      expect(fs.unlink).toHaveBeenCalledWith(
        path.normalize('/test/project/.vivekmind/agents/wrong-name.md'),
      );
    });
...
Target content`,
      ...
      expect(fs.unlink).toHaveBeenCalledWith(
        path.normalize('/test/project/.vivekmind/agents/target-file.md'),
      );
    });
  });
