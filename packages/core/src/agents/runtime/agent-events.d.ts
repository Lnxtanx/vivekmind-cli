...
export type AgentEvent = 'start' | 'round_start' | 'round_end' | 'round_text' | 'stream_text' | 'tool_call' | 'tool_result' | 'tool_output_update' | 'tool_waiting_approval' | 'usage_metadata' | 'external_message' | 'finish' | 'error' | 'status_change';
