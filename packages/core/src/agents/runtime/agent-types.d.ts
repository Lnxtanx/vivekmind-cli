...
export interface ModelConfig {
    /**
     * The name or identifier of the model to be used (e.g., 'vivekmind3-coder-plus').
     *
...
export declare const isTerminalStatus: (s: AgentStatus) => boolean;
/** True for IDLE or COMPLETED — agent finished its work successfully. */
export declare const isSuccessStatus: (s: AgentStatus) => boolean;
/** True for terminal statuses OR IDLE — agent has settled (not actively working). */
export declare const isSettledStatus: (s: AgentStatus) => boolean;
/**
