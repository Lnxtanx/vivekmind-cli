...
import type { BackgroundTaskEntry } from './background-tasks.js';
...
export declare class BackgroundAgentResumeService {
    ...
    loadPausedBackgroundAgents(sessionId: string): Promise<readonly BackgroundTaskEntry[]>;
    resumeBackgroundAgent(agentId: string, initialMessage?: string): Promise<BackgroundTaskEntry | undefined>;
