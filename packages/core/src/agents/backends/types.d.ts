...
import type { PromptConfig, ModelConfig, RunConfig, ToolConfig } from '../runtime/agent-types.js';
/**
 ...
 */
export type AgentExitCallback = (agentId: string, exitCode: number | null, signal: number | null) => void;
/**
