...
describe('createGeminiContentGenerator', () => {
    ...
    it('should pass baseUrl through httpOptions when provided', () => {
        ...
        expect(GeminiContentGenerator).toHaveBeenCalledWith(expect.objectContaining({
    ...
    it('should keep httpOptions unchanged when baseUrl is missing', () => {
        ...
        expect(vi.mocked(GeminiContentGenerator).mock.calls[0]?.[0]).not.toEqual(expect.objectContaining({
            httpOptions: expect.objectContaining({
