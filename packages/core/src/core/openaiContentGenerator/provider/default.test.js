...
describe('DefaultOpenAICompatibleProvider', () => {
    ...
    beforeEach(() => {
        ...
        provider = new DefaultOpenAICompatibleProvider(mockContentGeneratorConfig, mockCliConfig);
    });
    ...
    describe('buildRequest', () => {
        ...
        it('should set conservative max_tokens default when not configured', () => {
            ...
            const result = provider.buildRequest(requestWithoutMaxTokens, 'prompt-id');
        ...
        it('should merge extra_body into the request', () => {
            ...
            const result = providerWithExtraBody.buildRequest(originalRequest, 'prompt-id');
