...
import { TaggedThinkingParser, parseTaggedThinkingText, } from './taggedThinkingParser.js';
describe('TaggedThinkingParser', () => {
    ...
    it('should handle mixed usage of <think> and <thinking>', () => {
        const parser = new TaggedThinkingParser();
        expect(parser.parse('<think>a</think>b<thinking>c</thinking>d', true)).toEqual([
            { text: 'a', thought: true },
            { text: 'b' },
            { text: 'c', thought: true },
            { text: 'd' },
    ...
    it('should flush unclosed thought as text when stream ends with visible prefix', () => {
        ...
        expect(parser.parse('<think>done</think>visible <think>unclosed', true)).toEqual([
...
//# sourceMappingURL=taggedThinkingParser.test.js.map