...
export function convertOpenAIResponseToGemini(openaiResponse, requestContext) {
    ...
    if (choice) {
        ...
        if (choice.message.content) {
            parts.push(...convertOpenAITextToParts(choice.message.content, requestContext));
        }
        // Handle tool calls
...
export function convertOpenAIChunkToGemini(chunk, requestContext) {
    ...
    if (choice) {
        ...
        if (typeof choice.delta?.content === 'string') {
            parts.push(...convertOpenAITextToParts(choice.delta.content, requestContext, Boolean(choice.finish_reason)));
        }
