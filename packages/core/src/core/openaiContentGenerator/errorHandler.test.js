...
describe('EnhancedErrorHandler', () => {
    ...
    describe('shouldSuppressErrorLogging method', () => {
        it('should return false by default', () => {
            errorHandler = new EnhancedErrorHandler();
            const result = errorHandler.shouldSuppressErrorLogging(new Error('test'), mockRequest);
        ...
        it('should use custom suppression function', () => {
            ...
            const result = errorHandler.shouldSuppressErrorLogging(testError, mockRequest);
            expect(result).toBe(true);
            expect(customSuppressLogging).toHaveBeenCalledWith(testError, mockRequest);
        });
    });
    ...
    describe('error message building', () => {
        ...
        it('should build timeout error message', () => {
            ...
            expect(() => {
                errorHandler.handle(timeoutError, mockContext, mockRequest);
            }).toThrow(/Request timeout after 5s\. Try reducing input length or increasing timeout in config\./);
        });
        ...
        it('should handle different duration values correctly', () => {
            ...
            const timeoutError = new Error('timeout');
            expect(() => {
                errorHandler.handle(timeoutError, contextWithDifferentDuration, mockRequest);
    ...
    describe('ErrorHandler interface compliance', () => {
        it('should implement ErrorHandler interface correctly', () => {
            ...
            expect(errorHandler.shouldSuppressErrorLogging(new Error('test'), mockRequest)).toBe(false);
        });
    });
    describe('edge cases', () => {
        beforeEach(() => {
