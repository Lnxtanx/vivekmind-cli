 ...
 */
export declare class VivekMindContentGenerator extends OpenAIContentGenerator {
    private readonly debugLogger;
    private vivekmindClient;
    private sharedManager;
    private currentToken?;
    constructor(vivekmindClient: IVivekMindOAuth2Client, contentGeneratorConfig: ContentGeneratorConfig, cliConfig: Config);
    /**
