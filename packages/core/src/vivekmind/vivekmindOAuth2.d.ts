 ...
 */
export declare class VivekMindOAuth2Client implements IVivekMindOAuth2Client {
    private credentials;
...
export declare enum VivekMindOAuth2Event {
    AuthUri = "auth-uri",
 ...
 */
export declare const vivekmindOAuth2Events: EventEmitter<[never]>;
export declare function getVivekMindOAuthClient(config: Config, options?: {
 ...
 */
export declare function clearVivekMindCredentials(): Promise<void>;
export declare const clearCachedCredentialFile: typeof clearVivekMindCredentials;
