 ...
 */
export class VivekMindOAuth2Client {
    credentials = {};
    sharedManager;
    constructor() {
    ...
    async refreshAccessToken() {
        ...
        try {
            ...
            throw new Error(`VivekMind OAuth refresh returned invalid JSON: ${responseText || '(empty response body)'}`);
        }
        // Check if the response indicates success
...
export var VivekMindOAuth2Event;
(function (VivekMindOAuth2Event) {
    VivekMindOAuth2Event["AuthUri"] = "auth-uri";
    VivekMindOAuth2Event["AuthProgress"] = "auth-progress";
    VivekMindOAuth2Event["AuthCancel"] = "auth-cancel";
})(VivekMindOAuth2Event || (VivekMindOAuth2Event = {}));
/**
...
export async function getVivekMindOAuthClient(config, options) {
    ...
    try {
        ...
        if (options?.requireCachedCredentials) {
            throw new Error('VivekMind OAuth credentials expired. Please use /auth to re-authenticate.');
        }
        ...
        if (!result.success) {
            ...
            if (result.reason === 'timeout') {
                vivekmindOAuth2Events.emit(VivekMindOAuth2Event.AuthProgress, 'timeout', 'Authentication timed out. Please try again or select a different authentication method.');
            }
...
async function authWithVivekMindDeviceFlow(client, config) {
...
async function cacheVivekMindCredentials(credentials) {
 ...
 */
export async function clearVivekMindCredentials() {
    try {
        const filePath = getVivekMindCachedCredentialPath();
        ...
        debugLogger.warn('Warning: Failed to clear cached VivekMind credentials:', error);
    }
    finally {
...
function getVivekMindCachedCredentialPath() {
...
//# sourceMappingURL=vivekmindOAuth2.js.map