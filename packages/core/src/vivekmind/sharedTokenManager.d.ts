...
import { type VivekMindCredentials } from './vivekmindOAuth2.js';
...
export declare class SharedTokenManager {
     ...
     */
    getValidCredentials(vivekmindClient: IVivekMindOAuth2Client, forceRefresh?: boolean): Promise<VivekMindCredentials>;
    /**
