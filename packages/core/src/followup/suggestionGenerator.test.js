...
describe('shouldFilterSuggestion', () => {
    ...
    it('filters too many words', () => {
        expect(shouldFilterSuggestion('this is a very long suggestion with way too many words in it to show')).toBe(true);
    });
...
//# sourceMappingURL=suggestionGenerator.test.js.map