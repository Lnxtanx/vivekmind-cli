import { parseModelField, parsePathsField, validateSkillName, } from './types.js';
...
export function parseSkillContent(content, filePath) {
    ...
    const config = {
        ...
        // hooks for extension skills get `VIVEKMIND_SKILL_ROOT` set in their
        ...
        // broke `$VIVEKMIND_SKILL_ROOT/scripts/...` references in extension
        // skill hook commands.
        //
