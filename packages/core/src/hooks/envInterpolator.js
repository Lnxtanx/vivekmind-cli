 ...
 */
function isSafeVarName(varName) {
    return !DANGEROUS_VAR_NAMES.includes(varName);
}
export function interpolateEnvVars(value, allowedVars) {
 ...
 */
export function interpolateHeaders(headers, allowedVars) {
    const result = {};
 ...
 */
export function interpolateUrl(url, allowedVars) {
 ...
 */
export function hasEnvVarReferences(value) {
...
//# sourceMappingURL=envInterpolator.js.map