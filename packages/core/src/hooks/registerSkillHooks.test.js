...
describe('registerSkillHooks', () => {
    ...
    it('should register hooks with matcher pattern', () => {
        ...
        const count = registerSkillHooks(sessionHooksManager, sessionId, skill);
        expect(count).toBe(1);
        const hooks = sessionHooksManager.getHooksForEvent(sessionId, HookEventName.PreToolUse);
...
//# sourceMappingURL=registerSkillHooks.test.js.map