    ...
    async executeCommandHook(hookConfig, eventName, input, startTime, signal) {
        ...
        return new Promise((resolve) => {
            ...
            const env = {
                ...
                VIVEKMIND_PROJECT_DIR: input.cwd, // For VivekMind compatibility
                ...hookConfig.env,
            };
            ...
            child.on('close', (exitCode) => {
                ...
                if (textToParse) {
                    ...
                    try {
                        ...
                        output = this.convertPlainTextToHookOutput(textToParse, isBlockingError ? exitCode : exitCode || EXIT_CODE_SUCCESS);
                    }
                }
