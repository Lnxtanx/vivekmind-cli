...
describe('UrlValidator', () => {
    describe('isBlocked', () => {
        ...
        it('should block cloud metadata endpoints', () => {
            const validator = new UrlValidator([]);
            expect(validator.isBlocked('http://169.254.169.254/latest/meta-data')).toBe(true);
            expect(validator.isBlocked('http://metadata.google.internal/computeMetadata')).toBe(true);
        });
