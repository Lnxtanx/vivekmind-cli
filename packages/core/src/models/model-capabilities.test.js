...
describe('model-capabilities', () => {
    describe('getVisionCapability', () => {
        ...
        it('matches provider-qualified Bedrock model IDs by substring', () => {
            const capability = getVisionCapability('anthropic.claude-sonnet-4-20250514-v1:0');
            expect(capability).toMatchObject({
                supportsVision: true,
        ...
        it('returns a defensive copy of mutable arrays', () => {
            ...
            expect(VISION_MODEL_MAP['gpt-4o'].supportedImageTypes).not.toContain('mutated');
        });
    });
});
//# sourceMappingURL=model-capabilities.test.js.map