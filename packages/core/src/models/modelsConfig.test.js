...
describe('ModelsConfig', () => {
    ...
    it('should apply VivekMind OAuth apiKey placeholder during syncAfterAuthRefresh for fresh users', () => {
        ...
        modelsConfig.syncAfterAuthRefresh(AuthType.VIVEKMIND_OAUTH, modelsConfig.getModel());
        const gc = currentGenerationConfig(modelsConfig);
    ...
    it('should preserve CLI-sourced apiKey (--openaiApiKey) when registry model envKey is absent', () => {
        ...
        // Verify initial state
        expect(currentGenerationConfig(modelsConfig).apiKey).toBe('cli-provided-key');
    ...
    describe('reloadModelProvidersConfig', () => {
        ...
        it('should handle reload with empty config', async () => {
            ...
            expect(modelsConfig
                ...
                .filter((m) => m.authType !== AuthType.VIVEKMIND_OAUTH).length).toBeGreaterThan(0);
