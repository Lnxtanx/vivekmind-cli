...
import { detectImageMimeType, encodeImageToBase64, isImageFile, preprocessImage, } from './image-handler.js';
describe('image-handler', () => {
    ...
    describe('detectImageMimeType', () => {
        ...
        it('returns application/octet-stream for unknown data', () => {
            expect(detectImageMimeType(Buffer.from('not an image'))).toBe('application/octet-stream');
        });
    });
