...
import { clearWelcomeBackState, getProjectSummaryInfo, getWelcomeBackState, saveWelcomeBackRestartChoice, } from './projectSummary.js';
describe('projectSummary', () => {
    ...
    it('includes a summary fingerprint when a project summary exists', async () => {
        ...
        await fs.writeFile(path.join(testDir, '.vivekmind', 'PROJECT_SUMMARY.md'), [
            '## Overall Goal',
            'Ship the fix.',
            '',
            '## Current Plan',
...
//# sourceMappingURL=projectSummary.test.js.map