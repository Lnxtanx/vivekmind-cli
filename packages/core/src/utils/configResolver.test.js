...
import { resolveField, resolveOptionalField, layer, envLayer, cliSource, settingsSource, defaultSource, } from './configResolver.js';
describe('configResolver', () => {
    describe('resolveField', () => {
        ...
        it('returns default when all layers are undefined', () => {
            const result = resolveField([layer(undefined, cliSource('--model')), envLayer({}, 'MODEL')], 'default-model', defaultSource('default-model'));
...
//# sourceMappingURL=configResolver.test.js.map