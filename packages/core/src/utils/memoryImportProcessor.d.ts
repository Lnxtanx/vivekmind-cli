 ...
 */
export declare function processImports(content: string, basePath: string, importState?: ImportState, projectRoot?: string, importFormat?: 'flat' | 'tree'): Promise<ProcessImportsResult>;
