      ...
      if (entry.isFile()) {
        ...
        if (options.fileService) {
          const shouldIgnore =
            ...
            (options.fileFilteringOptions.respectVivekMindIgnore &&
              options.fileService.shouldVivekMindIgnoreFile(filePath));
          if (shouldIgnore) {
            continue;
          }
        }
      ...
      if (entry.isDirectory()) {
        ...
        if (options.fileService) {
          isIgnored =
            ...
            (options.fileFilteringOptions.respectVivekMindIgnore &&
              options.fileService.shouldVivekMindIgnoreFile(subFolderPath));
        }
