...
describe('ImageTokenizer', () => {
    ...
    describe('PNG dimension extraction', () => {
        it('should extract dimensions from valid PNG', async () => {
            ...
            const metadata = await tokenizer.extractImageMetadata(pngBase64, 'image/png');
        ...
        it('should handle invalid PNG gracefully', async () => {
            ...
            const metadata = await tokenizer.extractImageMetadata(invalidBase64, 'image/png');
    ...
    describe('batch processing', () => {
        ...
        it('should handle mixed valid and invalid images', async () => {
            const validPng = 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChAI9jU77yQAAAABJRU5ErkJggg==';
    ...
    describe('different image formats', () => {
        it('should handle different MIME types', async () => {
            ...
            for (const mimeType of formats) {
                const metadata = await tokenizer.extractImageMetadata(pngBase64, mimeType);
...
//# sourceMappingURL=imageTokenizer.test.js.map