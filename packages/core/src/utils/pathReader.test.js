...
const createMockConfig = (cwd, otherDirs = [], mockFileService, fileFilteringOptions) => {
...
describe('readPathFromWorkspace', () => {
    ...
    it.skipIf(process.platform === 'win32' || (process.getuid && process.getuid() === 0))('should return an error string if reading a file with no permissions', async () => {
        mock({
            [CWD]: {
