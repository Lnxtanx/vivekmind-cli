...
import { McpClient, MCPDiscoveryState, MCPServerStatus, populateMcpServerCommand, } from './mcp-client.js';
...
export class McpClientManager {
    ...
    constructor(config, toolRegistry, eventEmitter, sendSdkMcpMessage, healthConfig) {
