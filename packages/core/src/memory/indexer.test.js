...
import { buildManagedAutoMemoryIndex, rebuildManagedAutoMemoryIndex, } from './indexer.js';
...
describe('managed auto-memory indexer', () => {
    ...
    it('rewrites MEMORY.md from topic file contents', async () => {
        const projectFile = getAutoMemoryFilePath(projectRoot, path.join('project', 'repo-workspaces.md'));
