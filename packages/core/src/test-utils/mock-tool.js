...
export class MockTool extends BaseDeclarativeTool {
    ...
    execute;
    constructor(options) {
        super(options.name, options.displayName ?? options.name, options.description ?? options.name, options.kind ?? Kind.Other, options.params, options.isOutputMarkdown ?? false, options.canUpdateOutput ?? false);
