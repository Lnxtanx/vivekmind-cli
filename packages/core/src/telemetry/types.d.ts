...
export declare class ApiResponseEvent implements BaseTelemetryEvent {
     ...
     */
    subagent_name?: string;
    constructor(response_id: string, model: string, duration_ms: number, prompt_id: string, auth_type?: string, usage_data?: GenerateContentResponseUsageMetadata, response_text?: string, subagent_name?: string);
}
