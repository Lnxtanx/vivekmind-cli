...
declare const TOOL_CALL_COUNT = "vivekmind.tool.call.count";
declare const API_REQUEST_COUNT = "vivekmind.api.request.count";
declare const TOKEN_USAGE = "vivekmind.token.usage";
declare const FILE_OPERATION_COUNT = "vivekmind.file.operation.count";
export declare const SUBAGENT_EXECUTION_COUNT = "vivekmind.subagent.execution.count";
declare const STARTUP_TIME = "vivekmind.startup.duration";
declare const MEMORY_USAGE = "vivekmind.memory.usage";
declare const CPU_USAGE = "vivekmind.cpu.usage";
declare const TOOL_EXECUTION_BREAKDOWN = "vivekmind.tool.execution.breakdown";
declare const TOKEN_EFFICIENCY = "vivekmind.token.efficiency";
declare const API_REQUEST_BREAKDOWN = "vivekmind.api.request.breakdown";
declare const PERFORMANCE_SCORE = "vivekmind.performance.score";
declare const REGRESSION_DETECTION = "vivekmind.performance.regression";
declare const BASELINE_COMPARISON = "vivekmind.performance.baseline.comparison";
declare const COUNTER_DEFINITIONS: {
    readonly "vivekmind.tool.call.count": {
    ...
    readonly "vivekmind.api.request.count": {
    ...
    readonly "vivekmind.token.usage": {
    ...
    readonly "vivekmind.chat_compression": {
...
declare const HISTOGRAM_DEFINITIONS: {
    readonly "vivekmind.tool.call.latency": {
    ...
    readonly "vivekmind.api.request.latency": {
...
declare const PERFORMANCE_COUNTER_DEFINITIONS: {
    readonly "vivekmind.performance.regression": {
...
declare const PERFORMANCE_HISTOGRAM_DEFINITIONS: {
    readonly "vivekmind.startup.duration": {
    ...
    readonly "vivekmind.memory.usage": {
    ...
    readonly "vivekmind.tool.queue.depth": {
    ...
    readonly "vivekmind.tool.execution.breakdown": {
    ...
    readonly "vivekmind.token.efficiency": {
    ...
    readonly "vivekmind.api.request.breakdown": {
    ...
    readonly "vivekmind.performance.score": {
    ...
    readonly "vivekmind.performance.regression.percentage_change": {
    ...
    readonly "vivekmind.performance.baseline.comparison": {
