...
import { SessionService, buildApiHistoryFromConversation, getResumePromptTokenCount, } from './sessionService.js';
...
describe('SessionService', () => {
    ...
    describe('getResumePromptTokenCount', () => {
        ...
        it('should return latest assistant usage without scanning further back', () => {
            ...
            expect(getResumePromptTokenCount(makeConversation([compressionRecord, assistant]))).toBe(450);
        });
        it('should fall back to compression when latest assistant has zero usage', () => {
            ...
            expect(getResumePromptTokenCount(makeConversation([compressionRecord, assistant]))).toBe(300);
        });
    });
