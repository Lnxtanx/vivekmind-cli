 ...
 */
function applyPowerShellUtf8Prefix(command, shell) {
...
const replayTerminalOutput = async (output, cols, rows) => {
...
export class ShellExecutionService {
    ...
    static async execute(commandToExecute, cwd, onOutputEvent, abortSignal, shouldUseNodePty, shellExecutionConfig, options = {}) {
        ...
        return this.childProcessFallback(commandToExecute, cwd, onOutputEvent, abortSignal, options.streamStdout ?? false);
    }
    static childProcessFallback(commandToExecute, cwd, onOutputEvent, abortSignal, streamStdout) {
        try {
