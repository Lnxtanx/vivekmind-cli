...
export declare const EXTENSIONS_CONFIG_FILENAME = "vivekmind-extension.json";
export declare const INSTALL_METADATA_FILENAME = ".vivekmind-extension-install.json";
