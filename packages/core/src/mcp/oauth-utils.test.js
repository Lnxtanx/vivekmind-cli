...
describe('OAuthUtils', () => {
    ...
    describe('buildResourceParameter', () => {
        ...
        it('should strip query and fragment per RFC 8707', () => {
            const result = OAuthUtils.buildResourceParameter('https://example.com/mcp?foo=bar#frag');
            expect(result).toBe('https://example.com/mcp');
        });
        it('should remove trailing slash from paths', () => {
            expect(OAuthUtils.buildResourceParameter('https://example.com/mcp/')).toBe('https://example.com/mcp');
        });
        ...
        it('should preserve full path for multi-tenant MCP servers (issue #1749)', () => {
            const result = OAuthUtils.buildResourceParameter('https://mcp.alibaba-inc.com/yuque/mcp');
    ...
    describe('discoverOAuthConfig', () => {
        it('should use scopes from protected resource metadata when available', async () => {
            ...
            const result = await OAuthUtils.discoverOAuthConfig('https://www.modelscope.cn/mcp-server');
        ...
        it('should prefer protected resource scopes over auth server scopes', async () => {
            ...
            const result = await OAuthUtils.discoverOAuthConfig('https://example.com/mcp');
            expect(result).not.toBeNull();
