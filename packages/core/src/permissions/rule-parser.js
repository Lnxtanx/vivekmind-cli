 ...
 */
export function matchesPathPattern(specifier, filePath, projectRoot, cwd) {
 ...
 */
export function matchesRule(rule, toolName, command, filePath, domain, pathContext, specifier) {
    ...
    switch (kind) {
        ...
        case 'path': {
            ...
            return matchesPathPattern(rule.specifier, filePath, ctx.projectRoot, ctx.cwd);
        }
        case 'domain': {
            if (domain === undefined) {
                return false;
