 ...
 */
import { parseRules, parseRule, matchesRule, resolveToolName, splitCompoundCommand, SHELL_TOOL_NAMES, } from './rule-parser.js';
import { extractShellOperations } from './shell-semantics.js';
import { isShellCommandReadOnlyAST } from '../utils/shellAstParser.js';
import { detectCommandSubstitution, normalizeMonitorCommand, } from '../utils/shell-utils.js';
...
export class PermissionManager {
    ...
    evaluateSingle(ctx) {
        ...
        if (SHELL_TOOL_NAMES.has(toolName) && command !== undefined) {
            ...
            const virtualDecision = this.evaluateShellVirtualOps(extractShellOperations(command, cwd), pathCtx);
