...
describe('NativeLspService Integration Tests', () => {
    ...
    describe('Service Lifecycle', () => {
        ...
        it('should skip discovery for untrusted workspace', async () => {
            ...
            const untrustedService = new NativeLspService(mockConfig, mockWorkspace, eventEmitter, mockFileDiscovery, mockIdeStore, {
                workspaceRoot: mockWorkspace.rootPath,
    ...
    describe('Code Action Context', () => {
        it('should support filtering by code action kind', () => {
            ...
            const filteredActions = MOCK_LSP_RESPONSES['textDocument/codeAction'].filter((action) => kinds.includes(action.kind));
    ...
    describe('Error Handling', () => {
        it('should handle missing workspace gracefully', async () => {
            ...
            const service = new NativeLspService(mockConfig, emptyWorkspace, eventEmitter, mockFileDiscovery, mockIdeStore);
    ...
    describe('Security Controls', () => {
        it('should respect trust requirements', async () => {
            mockConfig.setTrusted(false);
            const strictService = new NativeLspService(mockConfig, mockWorkspace, eventEmitter, mockFileDiscovery, mockIdeStore, {
                requireTrustedWorkspace: true,
            });
...
//# sourceMappingURL=NativeLspService.integration.test.js.map