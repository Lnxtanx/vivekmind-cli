---
name: feat-dev
description: End-to-end workflow for implementing a non-trivial vivekmind
...
Use this workflow when implementing a feature in vivekmind that needs design,
...
Use `.vivekmind/` paths for planning artifacts:

- `.vivekmind/design/<feature>.md`
- `.vivekmind/e2e-tests/<feature>.md`

## Phase 1: Investigate

Understand the requested behavior and the current vivekmind implementation.
...
`vivekmind` CLI, not the local build.
